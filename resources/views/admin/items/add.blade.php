                ...
                <div class="card">
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col">
                                <h3 class="mb-0">Add Ingredient</h3>
                            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="form-group col-sm-5">
                                ...
                                <input id="item_name" type="text" class="form-control @error('item_name') is-invalid @enderror" name="item_name" value="{{ old('item_name') }}" required autocomplete="item_name" placeholder="Ingredient Name" autofocus>
                        ...
                        <div id="ingredient_section">
                            <div class="row ingredient_row">
                                <div class="form-group col-sm-5">
                                    <div class="input-group input-group-merge input-group-alternative mb-3">
                                        ...
                                        <select name="item_storage_type[]" id="item_storage_type" class="form-control @error('item_storage_type') is-invalid @enderror" required>
                                            ...
                                            @foreach($storage_types as $cat)
                                            <option value="{{ $cat['id'] }}" {{ ($category_id == $cat['id']) ? 'selected' : ''}}>{{ $cat['storage_name'] }}</option>
                                            @endforeach 
                                        </select>
                                ...
                                <input id="expire_days" type="text" class="form-control @error('expire_days') is-invalid @enderror" name="expire_days[]" value="{{ old('expire_days[]') }}" required autocomplete="expire_days" placeholder="Expiry Days" autofocus>
                                    ...
                                    <div class="blog_image">
                                        <div class="avatar-upload">
                                            <div class="avatar-edit">
                                                ...
                                                <input type="hidden" value={{  old("item_image")  }}  name=""/>
                                                <label for="item_image"><i class="fas fa-edit"></i></label>
                                            </div>
                                            <div class="avatar-preview">
                                                <div id="item_image_preview" style="background-image: url({{URL::asset('assets/img/thumbnail-default_2.jpg')}});">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="form-group"> 
                                ...
                                <textarea name="item_description" id="item_description" class="form-control @error('item_description') is-invalid @enderror" placeholder="Item Name" required>{{ old('item_description') }}</textarea>
