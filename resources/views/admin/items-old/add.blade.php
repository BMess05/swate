                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('saveItem') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input id="item_name" type="text" class="form-control @error('item_name') is-invalid @enderror" name="item_name" value="{{ old('item_name') }}" required autocomplete="item_name" placeholder="Item Name" autofocus>
